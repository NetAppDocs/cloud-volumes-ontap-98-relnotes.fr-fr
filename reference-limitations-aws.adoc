...
https://docs.netapp.com/us-en/cloud-manager-cloud-volumes-ontap/task-getting-started-aws-c2s.html#limitations["Affichez les limites de la Cloud Volumes ONTAP dans AWS C2S"^].
